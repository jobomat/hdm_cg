...
class tensionMap( om2.MPxNode ):
	...
	def postConstructor( self ):
		self.initialize_ramp( self.thisMObject(), self.aColorRamp, 0, 0.0, om2.MColor(), 1 )
		self.initialize_ramp( self.thisMObject(), self.aColorRamp, 1, 0.5, om2.MColor(), 1 )
		self.initialize_ramp( self.thisMObject(), self.aColorRamp, 2, 1.0, om2.MColor(), 1 )
